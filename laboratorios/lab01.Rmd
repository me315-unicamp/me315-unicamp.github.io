...
Você deverá criar um arquivo do tipo `Rmd`, que gere uma saída HTML, contendo a sua solução. Este arquivo deverá ser chamado `laboratorio01.Rmd` e enviado por meio do Moodle para avaliação.
...
10. Utilizando o comando `gather`, transforme `table4a` em um objeto no formato tidy. Armazene o resultado num objeto chamado `tidy4a`.
...
13. Use o comando `spread` para tranformar o objeto `table2` em um objeto com formato tidy.
